function simular() {
  ...
  for (var i = 0; i < prestacoes; i++) {
    ...
    if (i < 5) {
      ...
      tr.children[1].textContent = amortizacao.toLocaleString("pt-BR", {
        style: "currency",
        currency: "BRL",
      });
      tr.children[2].textContent = jurosPrestacao.toLocaleString("pt-BR", {
        style: "currency",
        currency: "BRL",
      });
      tr.children[3].textContent = totalPrestacao.toLocaleString("pt-BR", {
        style: "currency",
        currency: "BRL",
      });
    }
